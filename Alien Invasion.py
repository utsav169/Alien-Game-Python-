...
class Alien(Sprite):
    ...
    def __init__(self, ai_settings, screen):
        ...
        self.image = pygame.image.load('D:/Python/Alien Invasion/images/alien.bmp')
...
class Ship(Sprite):
    ...
    def __init__(self, ai_settings, screen):
        ...
        self.image = pygame.image.load('D:/Python/Alien Invasion/images/ship.bmp')
        self.rect = self.image.get_rect()
        self.screen_rect = screen.get_rect()
...
def get_number_rows(ai_settings, ship_height, alien_height):
    ...
    number_rows = int(available_space_y / (2 * alien_height) - 7)
    return number_rows
